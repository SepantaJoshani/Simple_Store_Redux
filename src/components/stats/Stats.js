...
const Stats = () => {
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-4 bg-blue-400 rounded-lg hover:opacity-80 md:space-x-6 dark:bg-coolGray-900 dark:text-coolGray-100">
		...
		<div className="flex p-4 space-x-4 bg-blue-400 rounded-lg hover:opacity-80 md:space-x-6 dark:bg-coolGray-900 dark:text-coolGray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg bg-grey-500 sm:p-4 dark:bg-violet-400">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 dark:text-coolGray-800">
